...
import fundacao from '../../assets/images/about/3.png';
...
<section class="page-hero d-flex align-items-center tringle-bg" id="page-hero">
  <div class="overlay-photo-image-bg" data-bg-img={pageHeroBG} data-bg-opacity=".2"></div>
              ...
              <div class="hero-social-icons mb-3 ">
                <div class="sc-wrapper dir-row sc-flat">
                  <ul class="sc-list">
                    ...
                    <li class="sc-item " title="instagram"><a class="sc-link" href="https://www.instagram.com/logncursos/" target="_blank" title="social media icon"><i class="fab fa-instagram sc-icon"></i></a></li>
      ...
      <div class="col-12   mx-md-auto col-lg-6 text-center " data-tilt>  
        <div class="hero-image-area mb-5 mb-lg-0">
          ...
          <div class="hero-img-wraper  ">
            <a href="https://www.artstation.com/artwork/eJGvED" target="_blank">
              <img class="img-fluid " src={astronauta} alt="" draggable="false">
            </a>
          </div>
  ...
  <div class="container">
    <div class="sec-heading  ">
      <div class="content-area">
        <span class="pre-title wow fadeInUp" data-wow-delay=".2s">cursos</span>
        <h2 class="title wow fadeInUp" data-wow-delay=".4s"><span class='hollow-text'>Nosso</span> Curso</h2>
        <p class="subtitle wow fadeInUp" data-wow-delay=".6s">
          No momento, disponibilizamos apenas um curso. Entretanto, estamos em processo de expansão e, em breve, lançaremos uma ampla gama de cursos para atender a todos os perfis de alunos, desde os iniciantes até os mais avançados.
        </p>
      </div>
    ...
    <div class="row gx-4 gy-4 services-row ">  
      <div class="col-12 col-md-6  col-lg-4 mx-auto ">
        ...
        <Link to="/curso" style="display: block" class="box service-box wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".1s">
          <div class="service-icon"><i class="flaticon-web-development font-icon"></i></div><span class="service-num hollow-text">1</span>
          <div class="service-content">
            <h3 class="service-title">Programação Para Iniciantes</h3>
            <p class="service-text">
              Este curso é indicado para quem deseja adquirir uma base sólida na programação,
              O curso também é indicado tanto para aqueles que precisam fortalecer seus
              conhecimentos acadêmicos quanto para profissionais já atuantes na área.
            </p>
          </div><span class="read-more">Inicie sua aventura!<i class="bi bi-arrow-right icon "> </i></span>
        </Link>
...
<section class="about mega-section" id="about">
  <div class="container">
    ...
    <div id="about1" class="content-block  ">
      <div class="row">
        <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end wow fadeInUp" data-wow-delay="0.6s">
          <div class="text-area ">
            <div class="sec-heading  light-title ">
              <div class="content-area"><span class="pre-title wow fadeInUp" data-wow-delay=".2s">Sobre nós</span>
                <h2 class=" title wow fadeInUp" data-wow-delay=".4s"><span class='hollow-text'>Fundado</span> em  <span class='featured-text'>2022.<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path></svg></span></h2>
              </div>
            </div>
            <p class=" about-text">Acreditamos que aprender a programar é mais do que apenas escrever códigos; é sobre resolver problemas, pensar de forma lógica e criar soluções inovadoras para o mundo.</p>
            <div class="cta-area"><Link class="btn-solid " to="/sobre">Sobre nós</Link>
              <div class="signature ">
                <div class="signature-img"></div>
                <div class="signature-name">CEO &amp; Fundador </div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-6 d-flex align-items-center order-0 order-lg-1 about-col wow fadeInUp" data-wow-delay="0.2s">
          <div class="img-area" data-tilt>
            <div class="image"><img class="about-img img-fluid " loading="lazy" src={fundacao} alt="Our vision"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="content-block  ">
      <div class="row">
        <div class="col-12 col-lg-6 d-flex align-items-center about-col wow fadeInUp" data-wow-delay="0.2s">
          <div class="img-area">
            <div class="image" data-tilt><img class="about-img img-fluid" loading="lazy" src={oportunidade} alt="about"></div>
          </div>
        </div>
        <div class="col-12 col-lg-6 d-flex align-items-center about-col pad-start wow fadeInUp" data-wow-delay="0.6s">
          <div class="text-area">
            <div class="sec-heading light-title">
              <div class="content-area">
                <span class="pre-title wow fadeInUp" data-wow-delay=".2s">Por que estudar na LOGN</span>
                <h2 class="title wow fadeInUp" data-wow-delay=".4s">Um futuro emocionante
                  <span class='hollow-text'> e repleto de</span>
                  <span class='featured-text'> oportunidades.<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path></svg></span></h2>
              </div>
            </div>
            <p class="about-text">Valorizamos o desenvolvimento pessoal de cada aluno, sua criatividade e a capacidade de resolver problemas. Ao estudar programação conosco, você estará em constante evolução. Junte-se a nós nessa empolgante jornada de aprendizado e começe a moldar o seu futuro hoje mesmo!</p>
            <div class="info-items-list">
              <div class="row ">
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number">01.</span>
                    <div class="info-content">
                      <h5 class="info-title">Tecnologia de ponta</h5>
                      <p class="info-text">
                        A Logn está comprometida em manter-se atualizada com as tecnologias mais recentes e relevantes do mercado. Isso significa que você estará aprendendo com as ferramentas e práticas mais atuais.</p>
                    </div>
                  </div>
                </div>
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number">02.</span>
                    <div class="info-content">
                      <h5 class="info-title">Teoria e prática</h5>
                      <p class="info-text">Além da teoria, temos foco na aplicação prática. Você aprenderá os conceitos básicos e fundamentais da programação e também trabalhará em projetos do mundo real que refletem os desafios que os programadores enfrentam no dia a dia.</p>
                    </div>
                  </div>
                </div>
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number">03.</span>
                    <div class="info-content">
                      <h5 class="info-title">Mentoria personalizada</h5>
                      <p class="info-text">Você terá acesso a sessões de mentoria individualizada para esclarecer dúvidas e receber orientações específicas para o seu progresso.</p>
                    </div>
                  </div>
                </div>
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number">04.</span>
                    <div class="info-content">
                      <h5 class="info-title">Número limitado de alunos por turma</h5>
                      <p class="info-text">
                        Nossas turmas são propositalmente pequenas, com número limitado de 06 alunos, isso garante que o mentor proporcione atenção individualizada para cada estudante.</p>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="cta-area"><Link class=" btn-solid " to="/sobre">Sobre nós</Link></div>
          </div>
        </div>
      </div>
    </div>
